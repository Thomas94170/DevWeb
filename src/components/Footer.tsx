        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="https://www.linkedin.com/in/thomas-thirion-776748145/" className="w-10 h-10 bg-slate-800 hover:bg-blue-600 rounded-lg flex items-center justify-center transition-colors">
                <Linkedin className="w-5 h-5" />
              </a>
              <a href="https://github.com/Thomas94170" className="w-10 h-10 bg-slate-800 hover:bg-blue-600 rounded-lg flex items-center justify-center transition-colors">
